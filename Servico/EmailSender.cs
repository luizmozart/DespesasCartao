using DespesasCartao.Entities;
using Microsoft.EntityFrameworkCore.Query.Internal;
using Microsoft.Extensions.Options;
using MimeKit;
using System.Net.Mail;

namespace DespesasCartao.Servico
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        public async Task SendEmailAsync(string email, string assunto, string mensagemTexto, string mensagemHtml)
        {
            ...
            //    {
            //        smtpClient.ServerCertificateValidationCallBack = (s, c, Hf, e) => true;
            //    };
            ...
            //    await smtpClient.DisconnetAsync(true).ConfigureAwait(false);
            //}
            //catch(Exception ex)
            //{
